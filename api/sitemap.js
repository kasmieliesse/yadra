...
const STATIC_PAGES = [
  ...
  { path: '/guides/procuration-immobiliere-algerie', priority: '0.5', changefreq: 'monthly' },
  { path: '/guides/echeancier-paiement-promoteur-algerie', priority: '0.5', changefreq: 'monthly' },
