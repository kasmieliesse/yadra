  ...
  try {
    if (kind === 'home') {
      ...
      var body = '<h1>yadra! — Marketplace immobilier premium en Algérie</h1>'
        ...
        + '<h2>Notre accompagnement</h2><ul>'
        + '<li><a href="' + SITE + '/promoteurs">Promoteurs vérifiés</a></li>'
        + '<li><a href="' + SITE + '/simulateur">Simulateur de rentabilité</a></li>'
        + '<li><a href="' + SITE + '/guides/acheter-depuis-letranger">Guides pratiques</a></li>'
        + '<li><a href="' + SITE + '/contact">Contact direct</a></li>'
        + '<li><a href="' + SITE + '/favoris">Favoris et comparaison</a></li>'
        + '<li><a href="' + SITE + '/donnees/prix-immobilier">Prix du marché</a></li></ul>'
